...
public class SpanExporterImpl implements SpanExporter {
  ...
  public SpanExporterImpl(String projectId, TraceServiceClient traceServiceClient,
  ...
  public ResultCode export(Collection<SpanData> spanDataList) {
    ...
    for (SpanData spanData : spanDataList) {
      spans.add(SpanTranslator.generateSpan(spanData, projectId, fixedAttributes));
    }
